...
**Within 90 days:**
- Begin building a **user research panel** immediately — this is the single highest-leverage infrastructure investment available. A panel is not a sign-up list; it is a structured database of consented participants profiled across the traits that matter: Bitcoin experience level, tech literacy, region, device type, federation, language, and whether they arrived through community or organic download. When a study needs "first-time users in Southeast Asia with no prior Bitcoin experience on Android," the answer is a filtered query, not a two-week recruitment sprint. Research velocity at the best companies is not a function of how fast researchers work — it is a function of how quickly they can access the right participants. Google's User Research team routinely runs studies in 5–7 days because their panel means 20+ qualified participants can be recruited in 48 hours. Meta runs same-week unmoderated studies at scale for the same reason. Coinbase's KYC-verified user base gives them a pre-screened, filterable recruitment pool that structurally compresses their research cycle. Fedi's existing community networks across LatAm, Africa, and Southeast Asia are the natural foundation for the same advantage — the panel should start being built on day one, so it is ready to serve every study that follows.
